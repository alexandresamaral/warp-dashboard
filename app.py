...
FILTER_ISSUES_UNTIL = "2020-08-31"  # e.g., '2021-12-01', 'today', etc
FILTER_ISSUES_SINCE = "2020-01-01"  # (pandas.to_datetime(FILTER_ISSUES_UNTIL) - pandas.Timedelta(days=365)).strftime('%Y-%m-%d')

SIMULATION_DAYS = 30  # N
SIMULATION_ITEMS = 30  # N
SIMULATIONS = 10
LAST_DAYS = 10
